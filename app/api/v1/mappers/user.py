...
def map_user_entity_to_user_auth_schema(
    user_entity: UserSubscriptionEntity,
) -> UserAuthResponse:
    ...
    return UserAuthResponse(
        ...
        screening_status=user_entity.user.screening_status,
        subscription=subscription_data,
    )


def map_user_with_subscription_entity_to_schema(
    user_entity: UserSubscriptionEntity,
) -> UserWithSubscriptionResponse:
...
def map_user_entity_to_user_schema(user_entity: UserEntity) -> UserResponse:
    return UserResponse(
        ...
        screening_status=user_entity.screening_status,
    )
