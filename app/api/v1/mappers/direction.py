...
def map_direction_schema_to_entity(
    direction_request: CreateDirectionRequest,
) -> DirectionEntity:
...
def map_direction_schema_and_id_to_entity(
    direction_request: UpdateDirectionRequest, telegram_chat_id: int
) -> DirectionEntity:
...
def map_direction_entity_to_schema(
...
def map_user_direction_access_schema_to_entity(
    user_id: int,
    telegram_chat_id: int,
    user_direction_access_schema: ChangeUserDirectionAccessRequest,
...
def map_user_direction_access_entity_to_schema(
    user_direction_access_entity: UserDirectionAccessEntity,
) -> UserDirectionAccessResponse:
