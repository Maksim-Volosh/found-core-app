...
from app.domain.exceptions import (DirectionNotFound,
...
async def create_user_direction_access(
    ...
    try:
        direction_response = await container.get_create_direction_use_case().create_user_direction_access(user_id=data.user_id, telegram_chat_id=data.telegram_chat_id)
