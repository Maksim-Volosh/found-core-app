...
async def stripe_webhook(
    ...
    success = await container.get_stripe_process_successful_payment_use_case(
...
async def cryptobot_webhook(
    ...
    success = await use_case.execute(payload=payload, sig_header=crypto_pay_api_signature)
