...
class DirectionUseCase:
    ...
    async def get_user_direction_access(
        ...
        user_direction = await self.repo.get_user_direction_access(
    ...
    async def change_user_direction_access(
        ...
        user_direction = await self.repo.change_user_direction_access(
...
class CreateDirectionUseCase:
    def __init__(
        self, direction_repo: IDirectionRepository, user_repo: IUserRepository
    ) -> None:
    ...
    async def create_user_direction_access(
        ...
        direction = await self.direction_repo.get_direction(
        ...
        user_direction = await self.direction_repo.create_user_direction_access(
            user_id=user_id, telegram_chat_id=telegram_chat_id
        )
