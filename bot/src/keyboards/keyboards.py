        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🚀 Вступить в сообщество", callback_data="buy_subscription"
                )
            ],
            [
                InlineKeyboardButton(
                    text="ℹ️ О сообществе", url="https://www.found-core.com/"
                ),
                InlineKeyboardButton(
                    text="🤝 Отзывы", url="https://www.found-core.com/#reviews"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="💼 Мой профиль", callback_data="guest_profile"
                ),
                InlineKeyboardButton(
                    text="❓ Поддержка / FAQ", callback_data="guest_support_faq"
                ),
            ],
        ]
    )
...
def get_months_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="🥈 2 месяца", callback_data="choose_payment_2"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🥇 3 месяца `-20%`", callback_data="choose_payment_3"
                )
            ],
            [
                InlineKeyboardButton(
                    text="◀️ Назад в меню", callback_data="back_to_guest_main"
                )
            ],
        ]
    )
...
def get_payment_keyboard(months: int) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="💳 Stripe", callback_data=f"stripe_payment_{months}"
                )
            ],
            [
                InlineKeyboardButton(
                    text="💲 Crypto Bot", callback_data=f"crypto_payment_{months}"
                )
            ],
            [
                InlineKeyboardButton(
                    text="💰 Другой", callback_data=f"rf_payment_{months}"
                )
            ],
            [
                InlineKeyboardButton(
...
def get_process_payment_keyboard(checkout_url: str) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="🔄 Проверить оплату", callback_data="verify_payment_status"
                )
            ],
            [
                InlineKeyboardButton(
...
def get_back_to_guest_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🚀 Хочу вступить!", callback_data="buy_subscription"
                )
            ],
...
def get_resident_main_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✨ Направления", callback_data="destination_list"
                )
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text="💼 Мой профиль", callback_data="resident_profile"
                ),
                InlineKeyboardButton(
                    text="❓ Поддержка / FAQ", callback_data="resident_support_faq"
                ),
            ],
        ]
    )
...
def get_destination_list_keyboard(directions: list) -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            text="🚀 Основное сообщество", callback_data=f"main_destination"
        )
    )
    ...
    builder.row(
        InlineKeyboardButton(text="◀️ Назад", callback_data=f"back_to_resident_main")
    )
...
def get_resident_back_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="◀️ Назад", callback_data="back_to_resident_main"
                )
            ]
        ]
    )
...
def get_extend_process_payment_keyboard(checkout_url: str) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="◀️ Назад в меню", callback_data="back_to_resident_main"
                )
            ],
        ]
    )
...
def get_extend_payment_keyboard(months: int) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="💳 Stripe", callback_data=f"extend_stripe_payment_{months}"
                )
            ],
            [
                InlineKeyboardButton(
                    text="💲 Crypto Bot",
                    callback_data=f"extend_crypto_payment_{months}",
                )
            ],
            [
                InlineKeyboardButton(
                    text="💰 Другой", callback_data=f"extend_rf_payment_{months}"
                )
            ],
            [
                InlineKeyboardButton(
...
def get_extend_months_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🥉 1 месяц", callback_data="extend_choose_payment_1"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🥈 2 месяца", callback_data="extend_choose_payment_2"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🥇 3 месяца `-20%`", callback_data="extend_choose_payment_3"
                )
            ],
            [
                InlineKeyboardButton(
...
def get_admin_main_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="👥 Список пользователей", callback_data="admin_get_users"
                )
            ],
            [
                InlineKeyboardButton(
                    text="✨ Список направлений", callback_data="admin_direction_list"
                )
            ],
            [
                InlineKeyboardButton(
...
def get_users_list_keyboard(
    all_users, telegram_id: int, page: int = 1, limit: int = 10
    ...
    for user in page_users:
        ...
        builder.row(
            InlineKeyboardButton(
                text=button_text, callback_data=f"admin_user_{user['user_id']}_{page}"
            )
        )
    ...
    builder.row(
        InlineKeyboardButton(text="👨🏻‍💻 Главная", callback_data="admin_back_to_main")
    )
...
def get_back_to_user_keyboard(user_id: int, page: int) -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            text="◀️ Назад", callback_data=f"admin_user_{user_id}_{page}"
        )
    )
    return builder.as_markup()


def get_user_levels_keyboard(
    user_id: int, user_level: int, page: int
) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    for i in range(1, 11):
        if i != user_level:
            builder.row(
                InlineKeyboardButton(
                    text=f"🟩 {i}", callback_data=f"admin_level_{user_id}_{i}_{page}"
                )
            )
        else:
            builder.row(
                InlineKeyboardButton(
                    text=f"✅ {i}", callback_data=f"admin_user_{user_id}_{page}"
                )
            )
...
def get_direction_list_access_keyboard(
    directions: list, user_id: int, page: int
) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    for direction in directions:
        builder.row(
...
def get_direction_card_keyboard(telegram_chat_id: int) -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            text="◀️ Назад", callback_data=f"admin_direction_info_{telegram_chat_id}"
        )
    )
    return builder.as_markup()
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🥉 1 месяц",
                    callback_data=f"give_subscription_{user_id}_{page}_1",
                )
            ],
            [
                InlineKeyboardButton(
                    text="🥈 2 месяца",
                    callback_data=f"give_subscription_{user_id}_{page}_2",
                )
            ],
            [
                InlineKeyboardButton(
                    text="🥇 3 месяца `-20%`",
                    callback_data=f"give_subscription_{user_id}_{page}_3",
                )
            ],
            [
                InlineKeyboardButton(
...
def get_superadmin_main_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="👑 Назначить админа", callback_data="super_admin_set_admin"
                )
            ],
        ]
    )
